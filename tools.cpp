...
//    _tools.push_back(Tool({ "Magic wand selection", FontAwesomeIcons::FA_MAGIC, nullptr }));
    _tools.push_back(Tool({ "Dropper", FontAwesomeIcons::FA_EYEDROPPER, DropperActionFactory::Instance() }));
...
//    _tools.push_back(Tool({ "Scratch remover", FontAwesomeIcons::FA_QUESTION, nullptr }));
    _tools.push_back(Tool({ "Erase", FontAwesomeIcons::FA_ERASER, EraseActionFactory::Instance() }));
